...
import { parseArgVal } from './iota-helper';
import { IotaFunc } from './iota-types';
import { log } from '../../utils/logger';
import { isHexadecimal } from './iota-parser';
...
const VectorArgForm: React.FunctionComponent<Props> = ({
  ...
  useEffect(() => {
    const parameterBoxes = document.getElementsByClassName('iota-parameter');
      ...
      if (
        ...
        return (
          <input
            ...
            className={'form-control iota-parameter'}
